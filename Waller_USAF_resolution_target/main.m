...
n1 = 2160; n2 = 2560;  % input image size

lambda = 0.6292;    % wavelength of illumination, assume monochromatic  HUB75 2mm pitch  R: 628.58nm  G: 519.5   B: 465.1
NA = 0.1;   % numerical aperture of the objective
mag = 8.1485;    %
dpix_c = 6.5;  %
Np = 600;  % # of pixels at the output image patch. Each patch will assign a single k-vector, the image patch size cannot be too large to keep the single-k assumption holds

ds_led = 4e3;   %Spacing between neighboring LEDs 2mm
decimation_led = 1;  %  Use every-other LED, so it's effectively 4mm spacing
z_led = 67.5e3;  % distance from the center LED to the object
dia_led = 19;   % diameter of # of LEDs used in the experiment

Ibk_thresh = 300;

lit_cenv = 13;   % set up LED coordinates
lit_cenh = 14;
vled = [0:31]-lit_cenv;
hled = [0:31]-lit_cenh;
